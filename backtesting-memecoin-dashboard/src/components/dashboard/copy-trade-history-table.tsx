...
export function CopyTradeHistoryTable() {
                ...
                <Table>
                    <TableHeader className="bg-neutral-950 border-b border-neutral-900">
                        <TableRow className="hover:bg-transparent border-none">
                            ...
                            <TableHead className="text-[8px] font-bold uppercase tracking-widest p-4 text-neutral-600">Wallet</TableHead>
                                ...
                                return (
                                    <TableRow key={i} className="border-b border-neutral-900/50 hover:bg-neutral-900/50 transition-colors">
                                        ...
                                        <TableCell className="text-[9px] font-mono p-4 text-neutral-400">
                                            {trade.copy_trade_address?.slice(0, 4)}...{trade.copy_trade_address?.slice(-4)}
                                        </TableCell>
