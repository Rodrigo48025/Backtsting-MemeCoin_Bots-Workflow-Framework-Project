...
import { getGraduationSniperDashboardData } from "@/app/actions/graduation-sniper-data";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { LineChart, Line, XAxis, YAxis, Tooltip, ResponsiveContainer, ReferenceLine } from "recharts";

export function GraduationMetricsCard() {
    const { data: rawData } = useSWR('graduation-sniper-data', getGraduationSniperDashboardData, { refreshInterval: 2000 });
        ...
        <Card className="bg-black border-neutral-900 rounded-none shadow-none h-full flex flex-col">
            <CardHeader className="px-6 py-4 border-b border-neutral-900 flex flex-row justify-between items-end">
                <div className="space-y-1">
                    <CardTitle className="text-[10px] font-bold uppercase tracking-[0.4em] text-neutral-500">Graduation_Sniper_Performance</CardTitle>
