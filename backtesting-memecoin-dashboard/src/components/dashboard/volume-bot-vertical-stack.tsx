...
import { getVolumeBotStatus, getVolumeLogs } from "@/app/actions/volume-data";
import { Card, CardContent } from "@/components/ui/card";

export function VolumeBotVerticalStack() {
                            ...
                            <div className="flex justify-between items-start">
                                <div className="space-y-1">
                                    <div className="flex items-center gap-2">
                                        <div className={`w-1.5 h-1.5 ${bot.status === 'ONLINE' ? 'bg-white' : bot.status === 'STALE' ? 'bg-neutral-600' : 'bg-red-600'}`} />
