...
export function VolumeStats() {
    ...
    const safeStats = {
        ...
        net_pnl_percentage: (parseFloat(stats.net_pnl_sol || "0") / 2.0) * 100, // Normalized to 2 SOL starting float
    ...
    return (
        <div className="flex flex-col gap-3 md:gap-4 font-mono">
            <div className="grid gap-2 md:gap-3 grid-cols-2 lg:grid-cols-5">
                ...
                <Card className="bg-black border-neutral-800 rounded-none shadow-none">
                    <CardHeader className="px-4 py-3 md:pb-2 border-b border-neutral-900">
                        <CardTitle className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">Momentum_Trades</CardTitle>
                    </CardHeader>
                    <CardContent className="px-4 pt-3 pb-3">
                ...
                <Card className="bg-black border-neutral-800 rounded-none shadow-none">
                    <CardHeader className="px-4 py-3 md:pb-2 border-b border-neutral-900">
                        <CardTitle className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">Active_Burst_Ops</CardTitle>
                    </CardHeader>
                    <CardContent className="px-4 pt-3 pb-3">
                ...
                <Card className="bg-black border-neutral-800 rounded-none shadow-none">
                    <CardHeader className="px-4 py-3 md:pb-2 border-b border-neutral-900">
                        <CardTitle className={`text-[10px] font-bold uppercase tracking-widest ${safeStats.net_pnl_percentage >= 0 ? 'text-white' : 'text-red-500'}`}>Net_Momentum</CardTitle>
                    </CardHeader>
                    <CardContent className="px-4 pt-3 pb-3">
                ...
                <Card className="bg-black border-neutral-800 rounded-none shadow-none col-span-2 lg:col-span-1">
                    <CardHeader className="px-4 py-3 md:pb-2 border-b border-neutral-900">
                        <CardTitle className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">Burst_Accuracy</CardTitle>
                    </CardHeader>
                    <CardContent className="px-4 pt-3 pb-3">
